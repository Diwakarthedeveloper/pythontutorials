...
clock.geometry('800x450') # size of the app window
...
lab_hour_txt = Label(clock,text="HOUR",font=('Time New Roman',15,"bold"), bg = 'red',fg="white")
...
lab_min_txt = Label(clock,text="MIN",font=('Time New Roman',15,"bold"), bg = 'red',fg="white")
...
lab_sec_txt = Label(clock,text="SEC",font=('Time New Roman',15,"bold"), bg = 'red',fg="white")
lab_sec_txt.place(x=400, y =160, height=20,width=100)

lab_ampm = Label(clock,text="00",font=('Time New Roman',40,"bold"), bg = 'red',fg="white")
lab_ampm.place(x=600, y =40, height=110,width=100)

lab_ampm_txt = Label(clock,text="AM/PM",font=('Time New Roman',15,"bold"), bg = 'red',fg="white")
...
lab_date_txt = Label(clock,text="DATE",font=('Time New Roman',15,"bold"), bg = 'red',fg="white")
...
lab_month_txt = Label(clock,text="MONTH",font=('Time New Roman',15,"bold"), bg = 'red',fg="white")
...
lab_year_txt = Label(clock,text="YEAR",font=('Time New Roman',15,"bold"), bg = 'red',fg="white")
...
lab_day_txt = Label(clock,text="DAY",font=('Time New Roman',15,"bold"), bg = 'red',fg="white")
